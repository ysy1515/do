...
const translations = {
  ar: {
    dashboardTitle: "Ù„ÙˆØ­Ø© Ø§Ù„Ù…Ù‡Ø§Ù…",
    report: "ØªØ­Ù…ÙŠÙ„ Ø§Ù„ØªÙ‚Ø±ÙŠØ±",
    ...
    addNewTask: "Ø¥Ø¶Ø§ÙØ© Ù…Ù‡Ù…Ø© Ø¬Ø¯ÙŠØ¯Ø©",
    addTaskCta: "Ø¥Ø¶Ø§ÙØ© Ù…Ù‡Ù…Ø©",
    composerSubtitle: "Ø£Ù†Ø´Ø¦ Ù…Ù‡Ù…Ø© Ø¬Ø¯ÙŠØ¯Ø© Ø¹Ù†Ø¯ Ø§Ù„Ø­Ø§Ø¬Ø© Ø¨Ø¯ÙˆÙ† Ø§Ø²Ø¯Ø­Ø§Ù… Ø§Ù„ØµÙØ­Ø©.",
    editTask: "ØªØ¹Ø¯ÙŠÙ„ Ø§Ù„Ù…Ù‡Ù…Ø©",
    cancel: "Ø¥Ù„ØºØ§Ø¡",
    otpEmailLabel: "Ø§Ù„Ø¨Ø±ÙŠØ¯ Ø§Ù„Ø¥Ù„ÙƒØªØ±ÙˆÙ†ÙŠ",
    otpEmailPlaceholder: "Ø£Ø¯Ø®Ù„ Ø§Ù„Ø¨Ø±ÙŠØ¯ Ø§Ù„Ø¥Ù„ÙƒØªØ±ÙˆÙ†ÙŠ Ø§Ù„Ù…ØµØ±Ø­",
    otpHelper: "Ø£Ø¯Ø®Ù„ Ø§Ù„Ø¨Ø±ÙŠØ¯ Ø§Ù„Ø¥Ù„ÙƒØªØ±ÙˆÙ†ÙŠ Ø§Ù„Ù…ØµØ±Ø­ Ù„Ø§Ø³ØªÙ„Ø§Ù… Ø±Ù…Ø² Ø§Ù„ØªØ­Ù‚Ù‚",
    sendOtp: "Ø¥Ø±Ø³Ø§Ù„ Ø±Ù…Ø² Ø§Ù„ØªØ­Ù‚Ù‚",
    sendingOtp: "Ø¬Ø§Ø±Ù Ø§Ù„Ø¥Ø±Ø³Ø§Ù„...",
    otpSent: "ØªÙ… Ø¥Ø±Ø³Ø§Ù„ Ø±Ù…Ø² Ø§Ù„ØªØ­Ù‚Ù‚. ØªØ­Ù‚Ù‚ Ù…Ù† Ø¨Ø±ÙŠØ¯Ùƒ Ø§Ù„Ø¥Ù„ÙƒØªØ±ÙˆÙ†ÙŠ.",
    invalidAuthorizedEmail: "Ø§Ù„Ø¨Ø±ÙŠØ¯ Ø§Ù„Ø¥Ù„ÙƒØªØ±ÙˆÙ†ÙŠ ØºÙŠØ± Ù…ØµØ±Ø­",
    taskTitle: "Ø¹Ù†ÙˆØ§Ù† Ø§Ù„Ù…Ù‡Ù…Ø©",
    description: "ÙˆØµÙ Ø§Ø®ØªÙŠØ§Ø±ÙŠ",
    priority: "Ø§Ù„Ø£ÙˆÙ„ÙˆÙŠØ©",
    dueDate: "ØªØ§Ø±ÙŠØ® Ø§Ù„ØªØ³Ù„ÙŠÙ…",
    addTask: "Ø¥Ø¶Ø§ÙØ© Ø§Ù„Ù…Ù‡Ù…Ø©",
    saveEdit: "Ø­ÙØ¸ Ø§Ù„ØªØ¹Ø¯ÙŠÙ„",
    cancelEdit: "Ø¥Ù„ØºØ§Ø¡ Ø§Ù„ØªØ¹Ø¯ÙŠÙ„",
    currentTasks: "Ø§Ù„Ù…Ù‡Ø§Ù… Ø§Ù„Ø­Ø§Ù„ÙŠØ©",
    completedSection: "Ø§Ù„Ù…Ù‡Ø§Ù… Ø§Ù„Ù…ÙƒØªÙ…Ù„Ø©",
    noActive: "Ù„Ø§ ØªÙˆØ¬Ø¯ Ù…Ù‡Ø§Ù… Ø­Ø§Ù„ÙŠØ©",
    noCompleted: "Ù„Ø§ ØªÙˆØ¬Ø¯ Ù…Ù‡Ø§Ù… Ù…ÙƒØªÙ…Ù„Ø©",
    high: "Ø¹Ø§Ù„ÙŠØ©",
    medium: "Ù…ØªÙˆØ³Ø·Ø©",
    low: "Ù…Ù†Ø®ÙØ¶Ø©",
    active: "Ù†Ø´Ø·Ø©",
    ...
    overdue: "Ù…ØªØ£Ø®Ø±Ø©",
    priorityPrefix: "Ø§Ù„Ø£ÙˆÙ„ÙˆÙŠØ©",
    duePrefix: "Ø§Ù„ØªØ³Ù„ÙŠÙ…",
    completedPrefix: "Ø§Ù„Ø¥ÙƒÙ…Ø§Ù„",
    markCompleted: "ØªØ­Ø¯ÙŠØ¯ ÙƒÙ…ÙƒØªÙ…Ù„Ø©",
    edit: "ØªØ¹Ø¯ÙŠÙ„",
    delete: "Ø­Ø°Ù",
    showMore: "Ø¹Ø±Ø¶ Ø§Ù„Ù…Ø²ÙŠØ¯",
    showLess: "Ø¹Ø±Ø¶ Ø£Ù‚Ù„",
    footer: "Â© 2026 Ø¬Ù…ÙŠØ¹ Ø§Ù„Ø­Ù‚ÙˆÙ‚ Ù…Ø­ÙÙˆØ¸Ø© Ù„ÙŠØ­ÙŠÙ‰ Ø§Ù„Ø´Ù‡Ø±Ø§Ù†ÙŠ",
    langToggle: "EN",
    reportFile: "ØªÙ‚Ø±ÙŠØ±-Ø§Ù„Ù…Ù‡Ø§Ù….csv"
  },
  en: {
    ...
    showMore: "Show more",
    showLess: "Show less",
    footer: "Â© 2026 All rights reserved to Yahya Alshahrani",
    langToggle: "AR",
...
async function api(path, options = {}) {
  ...
  if (!response.ok) {
    const error = new Error(payload?.error || "Ø­Ø¯Ø« Ø®Ø·Ø£ ØºÙŠØ± Ù…ØªÙˆÙ‚Ø¹.");
